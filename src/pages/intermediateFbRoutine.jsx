...
function IntermediateFBRoutine() {
    ...
    async function fetchRoutine() {
      try {
        const res = await axios.get(
          `http://localhost:8000/api/routines/intermediate/user/${userId}`
        );
        setRoutine(res.data);
  ...
  return (
    <div className="main-container">
      ...
      <div className="info-container">
        ...
        <button onClick={handleCompleteRoutine} className="finish-button">Rutina Terminada</button>
      </div>
...
export default IntermediateFBRoutine;
